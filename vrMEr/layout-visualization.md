...
R2: TRNS    DE_SECT MT(A,DE_SLSH) MT(G,DE_LCBR) MT(S,DE_RCBR) DE_ASTR DE_QUES MT(S,DE_LPRN) MT(G,DE_RPRN) MT(A,DE_MINS) DE_TILD TRNS
R3: TRNS    MT(C,DE_AT) DE_BSLS DE_PIPE DE_DQOT DE_GRV   DE_PLUS  DE_PERC  DE_DLR   DE_HASH  MT(C,DE_COLN) TRNS
