...
- C (QMK Firmware compatible with AVR-GCC compiler) + QMK Firmware (qmk_firmware submodule), QMK MOUSEKEY module, German keyboard layout definitions (keymap_german.h) (003-mouse-layer)
...
## Recent Changes
- 003-mouse-layer: Added C (QMK Firmware compatible with AVR-GCC compiler) + QMK Firmware (qmk_firmware submodule), QMK MOUSEKEY module, German keyboard layout definitions (keymap_german.h)
